...
select_kernel_version() {
    ...
    # Выводим информацию напрямую в терминал
    {
        ...
        echo "----------------------------------------"
        echo -e "Текущая дата:      \033[1;36m2025-02-15 04:47:42 UTC\033[0m"
        ...
        echo "• Для домашних ПК и серверов   → \033[1;32mСтабильная (1)\033[0m"
        echo "• Для энтузиастов              → \033[1;33mEdge (2)\033[0m"
        echo "• Для аудио/видео обработки    → \033[1;35mRT (3)\033[0m"
        echo "• Для рабочих станций          → \033[1;34mLTS (4)\033[0m"
